...
namespace Prism.Regions.Behaviors
{
    ...
    public class RegionManagerRegistrationBehavior : RegionBehavior, IHostAwareRegionBehavior
    {
        ...
        {
            Visual targetElement = this.HostControl;
        ...
        private IRegionManager FindRegionManager(Visual visual)
        {
            var regionmanager = this.RegionManagerAccessor.GetRegionManager(visual);
            if (regionmanager != null)
            {
            ...
            Visual parent = null;
            parent = visual.GetVisualParent() as Visual;
            if (parent != null)
            {
