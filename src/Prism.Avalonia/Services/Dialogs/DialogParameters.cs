...
{
    /// <summary>Represents Dialog parameters.</summary>
    /// <remarks>
    ...
    {
        /// <summary>Initializes a new instance of the <see cref="DialogParameters"/> class.</summary>
        public DialogParameters() : base() { }

        /// <summary>Constructs a list of parameters.</summary>
