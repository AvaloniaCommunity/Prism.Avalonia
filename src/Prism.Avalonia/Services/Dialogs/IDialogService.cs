...
namespace Prism.Services.Dialogs
{
    ...
    public interface IDialogService
    {
        ...
        void Show(string name, IDialogParameters parameters, Action<IDialogResult> callback = null);
        ...
        /// <param name="parameters">The parameters to pass to the dialog.</param>
        /// <param name="callback">The action to perform when the dialog is closed.</param>
        void ShowDialog(string name, IDialogParameters parameters, Action<IDialogResult> callback = null);
        ...
        /// <param name="parameters">The parameters to pass to the dialog.</param>
        /// <param name="callback">The action to perform when the dialog is closed.</param>
        void ShowDialog(Window owner, string name, IDialogParameters parameters, Action<IDialogResult> callback = null);
    }
}
