...
namespace Prism.Interactivity
{
    ...
    /// </summary>
    public class PopupWindowAction : TriggerAction<Control>
    {
        /// <summary>
        /// The content of the child window to display as part of the popup.
        /// </summary>
        public static readonly StyledProperty WindowContentProperty =
            StyledProperty.Register(
                "WindowContent",
                typeof(Control),
        ...
        /// </summary>
        public static readonly StyledProperty WindowContentTypeProperty =
            StyledProperty.Register(
                "WindowContentType",
                typeof(Type),
                typeof(PopupWindowAction),
        ...
        /// </summary>
        public static readonly StyledProperty IsModalProperty =
            StyledProperty.Register(
                "IsModal",
                typeof(bool),
                typeof(PopupWindowAction),
        ...
        /// </summary>
        public static readonly StyledProperty CenterOverAssociatedObjectProperty =
            StyledProperty.Register(
        ...
        /// </summary>
        public static readonly StyledProperty WindowStyleProperty =
            StyledProperty.Register(
                "WindowStyle",
                typeof(Style),
                typeof(PopupWindowAction),
        ...
        {
            get { return (Control)GetValue(WindowContentProperty); }
            ...
            if (this.CenterOverAssociatedObject && this.AssociatedObject != null)
            {
                ...
                sizeHandler =
                    (o, e) =>
                    {
                        ...
                        Control view = this.AssociatedObject;
